...
const LandingPage = () => {
  ...
  const handleStartConfiguring = () => {
    if (isConfigurationReady) {
      // Navigate to configuration page with selected options
      navigate('/configure', { 
        state: { 
          gradingTemplate, 
          feedbackMode 
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-50">
      ...
      {/* Main Content */}
      <div className="flex items-center justify-center px-6 pb-6" style={{minHeight: 'calc(100vh - 120px)'}}>
        ...
        <div className="bg-gray-800 rounded-2xl shadow-xl p-8 md:p-10 border border-gray-700">
          <div className="space-y-8">
            ...
            {(gradingTemplate || feedbackMode) && (
              <div className="bg-gray-700 rounded-lg p-4 border-l-4 border-indigo-400 border border-gray-600">
                ...
                <div className="space-y-1 text-sm text-gray-400">
                  ...
                  {feedbackMode && (
                    <p>
                      <span className="font-medium text-gray-300">Feedback:</span> {
                        feedbackModeOptions.find(opt => opt.value === feedbackMode)?.label
                      }
                    </p>
                  )}
                </div>
        ...
        {/* Open Source Hook */}
        <div className="mt-12 bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-8 border border-indigo-500/30 backdrop-blur-sm">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                ...
                className="inline-flex items-center px-6 py-3 bg-gray-800 hover:bg-gray-700 text-white font-semibold rounded-lg transition-all duration-200 border border-gray-600 hover:border-gray-500 group"
              >
